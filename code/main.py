...
parser.add_argument('--dataset_name_train_valid', dest='dataset_train_valid', default='../dataset/dataset_train_valid.npy', help='name of the dataset_train_valid')
parser.add_argument('--dataset_name_test', dest='dataset_test', default='../dataset/dataset_test.npy', help='name of the dataset_test')
